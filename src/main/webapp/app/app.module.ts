...
import { JhipsterSampleApplication2SharedModule, UserRouteAccessService } from './shared';
...
import { JhipsterSampleApplication2AccountModule } from './account/account.module';
...
@NgModule({
    imports: [
        ...
        JhipsterSampleApplication2AccountModule,
